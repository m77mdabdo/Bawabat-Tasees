...
return [
     ...
     */
    'flash' => [
        'comment_submitted' => 'تم إرسال تعليقك وسيظهر بعد المراجعة.',
        'consultation_submitted' => 'شكرًا لك! تم استلام طلبك وسنتواصل معك قريبًا.',
        'contact_submitted' => 'شكرًا لتواصلك معنا! سنرد عليك في أقرب وقت ممكن.',
    ],
