...
<div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
            <x-input-label for="client_country" :value="__('Client Country')" />
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <x-input-label for="quote_ar" :value="__('Quote (Arabic)')" />
        ...
        <div>
            <x-input-label for="quote_en" :value="__('Quote (English)')" />
