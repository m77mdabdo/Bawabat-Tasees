...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <x-input-label for="summary_ar" :value="__('dashboard.services.summary_ar')" />
        ...
        <div>
            <x-input-label for="summary_en" :value="__('dashboard.services.summary_en')" />
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <x-input-label for="body_ar" :value="__('dashboard.services.body_ar')" />
        ...
        <div>
            <x-input-label for="body_en" :value="__('dashboard.services.body_en')" />
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <x-input-label for="requirements_ar" :value="__('dashboard.services.requirements_ar')" />
        ...
        <div>
            <x-input-label for="requirements_en" :value="__('dashboard.services.requirements_en')" />
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <x-input-label for="process_ar" :value="__('dashboard.services.process_ar')" />
        ...
        <div>
            <x-input-label for="process_en" :value="__('dashboard.services.process_en')" />
    ...
    <div class="flex items-center gap-6">
        <label class="inline-flex items-center">
            ...
            <span class="ms-2 text-sm text-gray-600">{{ __('dashboard.services.flagship_label') }}</span>
        </label>
        <label class="inline-flex items-center">
