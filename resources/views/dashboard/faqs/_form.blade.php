...
<div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <x-input-label for="question_ar" :value="__('dashboard.faqs.question_ar')" />
        ...
        <div>
            <x-input-label for="question_en" :value="__('dashboard.faqs.question_en')" />
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <x-input-label for="answer_ar" :value="__('dashboard.faqs.answer_ar')" />
        ...
        <div>
            <x-input-label for="answer_en" :value="__('dashboard.faqs.answer_en')" />
