...
class TranslateContentToEnglish extends Command
{
    ...
    private array $translations = [
        ...
        'تعرف على بوابة تأسيس الشركات، شريكك الموثوق لتأسيس الأعمال والاستثمار في المملكة العربية السعودية.'
            => 'Learn about Bawabat Taasees Al Sharikat, your trusted partner for business formation and investment in Saudi Arabia.',

        // Page: why-invest-saudi-arabia
        'لماذا تستثمر في السعودية' => 'Why Invest in Saudi Arabia',
        '<p>تشهد المملكة العربية السعودية تحولاً اقتصادياً واسعاً في إطار رؤية المملكة 2030، ما يفتح آفاقاً واعدة أمام المستثمرين من مختلف القطاعات. فيما يلي أبرز العوامل التي تجعل من السعودية وجهة استثمارية جديرة بالاهتمام.</p>'
            => '<p>Saudi Arabia is undergoing a sweeping economic transformation under Vision 2030, opening promising opportunities for investors across a wide range of sectors. Below are the key factors that make Saudi Arabia a compelling investment destination.</p>',
        'لماذا تستثمر في السعودية — بوابة تأسيس الشركات' => 'Why Invest in Saudi Arabia — Bawabat Taasees Al Sharikat',
        'أبرز عوامل الجذب الاستثماري في المملكة العربية السعودية للمستثمرين المحليين والأجانب.'
            => 'Key investment drivers in the Kingdom of Saudi Arabia for local and foreign investors.',

        // Page: formation-process
        'خطوات تأسيس الشركة' => 'Company Formation Process',
        '<p>تمر عملية تأسيس شركة في المملكة العربية السعودية بعدة مراحل أساسية. فيما يلي نظرة عامة على الخطوات المعتادة — قد تختلف التفاصيل الدقيقة حسب النشاط التجاري وجنسية المستثمر ونوع الترخيص المطلوب.</p>'
            => "<p>Establishing a company in Saudi Arabia involves several core stages. Below is an overview of the typical steps — exact details may vary depending on the business activity, the investor's nationality, and the type of licence required.</p>",
        'خطوات تأسيس الشركة — بوابة تأسيس الشركات' => 'Company Formation Process — Bawabat Taasees Al Sharikat',
        'الخطوات الأساسية لتأسيس شركة في المملكة العربية السعودية، من الاستشارة الأولى وحتى الانطلاق التشغيلي.'
            => 'The core steps to establishing a company in Saudi Arabia, from the first consultation through operational launch.',

        // Page: required-documents
        'المستندات المطلوبة' => 'Required Documents',
        '<p>فيما يلي المستندات الشائع طلبها عند تأسيس شركة في المملكة العربية السعودية. تختلف المتطلبات الفعلية حسب نوع النشاط والجنسية والشكل القانوني للشركة، وسيقوم فريقنا بتزويدك بقائمة دقيقة بعد الاستشارة الأولية.</p>'
            => "<p>Below are the documents commonly requested when establishing a company in Saudi Arabia. Actual requirements vary depending on the business activity, nationality, and legal form of the company — our team will provide you with a precise list following your initial consultation.</p>",
        'المستندات المطلوبة — بوابة تأسيس الشركات' => 'Required Documents — Bawabat Taasees Al Sharikat',
        'قائمة عامة بالمستندات الشائع طلبها لتأسيس شركة في المملكة العربية السعودية.'
            => 'A general list of documents commonly required to establish a company in Saudi Arabia.',

        // PageSection: why-invest-saudi-arabia
        'التوافق مع رؤية 2030' => 'Aligned with Vision 2030',
        'استراتيجية وطنية شاملة تعمل على تنويع الاقتصاد وفتح قطاعات جديدة أمام الاستثمار المحلي والأجنبي.'
        ...
        'تتيح الأنظمة الحالية للمستثمرين الأجانب تملك 100% من شركاتهم في كثير من الأنشطة التجارية دون الحاجة لشريك محلي.'
            => 'Current regulations allow foreign investors to own 100% of their companies in many business activities, with no local partner required.',
        'موقع استراتيجي' => 'Strategic Location',
        'تتوسط المملكة قارات آسيا وأفريقيا وأوروبا، ما يمنحها موقعاً لوجستياً مميزاً للوصول إلى أسواق إقليمية وعالمية.'
            => 'Saudi Arabia sits at the crossroads of Asia, Africa, and Europe, giving it an outstanding logistical position for reaching regional and global markets.',
        'اقتصاد متنامٍ' => 'A Growing Economy',
        'يشهد الاقتصاد السعودي نمواً مستمراً مدعوماً باستثمارات ضخمة في البنية التحتية والقطاعات غير النفطية.'
            => 'The Saudi economy continues to grow, backed by substantial investment in infrastructure and non-oil sectors.',
        'تسهيلات في بيئة الأعمال' => 'A Streamlined Business Environment',
        'تعمل الجهات الحكومية على تبسيط إجراءات التأسيس والترخيص من خلال منصات رقمية متكاملة.'
            => 'Government authorities are simplifying formation and licensing procedures through integrated digital platforms.',
        'حوافز حكومية' => 'Government Incentives',
        'تقدم الجهات المختصة برامج وحوافز متنوعة لدعم المستثمرين في قطاعات ذات أولوية استراتيجية.'
            => 'Relevant authorities offer a range of programs and incentives to support investors in strategically prioritised sectors.',

        // PageSection: formation-process
        'الاستشارة الأولية' => 'Initial Consultation',
        'نناقش أهدافك الاستثمارية ونشاطك التجاري المستهدف لتحديد أفضل مسار قانوني وإداري للتأسيس.'
            => 'We discuss your investment goals and target business activity to determine the best legal and administrative path for formation.',
        'حجز الاسم التجاري' => 'Trade Name Reservation',
        'اختيار وحجز الاسم التجاري للشركة لدى الجهة المختصة.'
            => "Selecting and reserving your company's trade name with the relevant authority.",
        'إعداد عقد التأسيس ولائحته الداخلية' => 'Drafting the Articles of Association and Bylaws',
        'صياغة عقد التأسيس والنظام الأساسي للشركة وفق النشاط والشكل القانوني المختار.'
            => "Drafting the company's Articles of Association and bylaws in line with the chosen activity and legal form.",
        'الحصول على ترخيص الاستثمار (إن لزم الأمر)' => 'Obtaining an Investment Licence (if required)',
        'استخراج الترخيص اللازم من الجهة المختصة بالاستثمار الأجنبي للأنشطة التي تتطلب ذلك.'
            => 'Securing the necessary licence from the foreign investment authority for activities that require one.',
        'استخراج السجل التجاري' => 'Issuing the Commercial Registration',
        'تسجيل الشركة رسمياً والحصول على السجل التجاري.'
            => 'Formally registering the company and obtaining its Commercial Registration (CR).',
        'فتح الحساب البنكي للشركة' => "Opening the Company's Bank Account",
        'فتح حساب بنكي مؤسسي باسم الشركة لدى أحد البنوك المحلية المعتمدة.'
            => "Opening a corporate bank account in the company's name with an approved local bank.",
        'التسجيل في المنصات الحكومية والانطلاق التشغيلي' => 'Registering with Government Platforms and Launching Operations',
        'إتمام التسجيل في المنصات الحكومية ذات الصلة (كالتأمينات الاجتماعية والزكاة والضريبة) والبدء الفعلي في مزاولة النشاط.'
            => 'Completing registration with the relevant government platforms (such as GOSI and ZATCA) and formally beginning operations.',

        // PageSection: required-documents
        'نسخة من جواز السفر' => 'Passport Copy',
        'نسخة سارية المفعول من جواز سفر المستثمر أو المستثمرين الشركاء.'
            => 'A valid copy of the passport of the investor or investing partners.',
        'مستندات الشركة الأم (إن وجدت)' => 'Parent Company Documents (if applicable)',
        'مستندات تسجيل الشركة من بلد المنشأ في حال كان المستثمر شركة قائمة وليس فرداً.'
            => "Registration documents from the company's home country, if the investor is an existing company rather than an individual.",
        'خيارات الاسم التجاري المقترح' => 'Proposed Trade Name Options',
        'عدة خيارات مقترحة للاسم التجاري تسهيلاً لعملية الحجز والاعتماد.'
            => 'Several proposed trade name options to streamline the reservation and approval process.',
        'وكالة رسمية (عند الحاجة)' => 'Power of Attorney (if needed)',
        'وكالة موثقة في حال الاستعانة بممثل لإنجاز إجراءات التأسيس نيابة عن المستثمر.'
            => "A notarised power of attorney if a representative will complete the formation procedures on the investor's behalf.",
        'ملف تعريفي بالنشاط' => 'Business Activity Profile',
        'نبذة عن النشاط التجاري المستهدف وخطة العمل المبدئية.'
            => 'An overview of the target business activity and preliminary business plan.',
        'عنوان مراسلة صالح' => 'Valid Correspondence Address',
        'عنوان بريد إلكتروني ورقم تواصل صالحين للمراسلات الرسمية أثناء إجراءات التأسيس.'
            => 'A valid email address and contact number for official correspondence during the formation process.',
    ];
        ...
        foreach ($modelClass::all() as $model) {
            ...
            foreach ($fields as $field) {
                ...
                if ($en === null) {
                    ...
                    $this->untranslatable[] = $modelClass.'#'.$model->getKey()." [{$field}]: ".\Illuminate\Support\Str::limit($ar, 60);
    ...
    private function translatePageSections(bool $force): array
    {
        ...
        foreach (PageSection::all() as $section) {
            ...
            foreach (['title', 'description'] as $field) {
                ...
                if ($en === null) {
                    $stats['skipped_no_translation']++;
                    $this->untranslatable[] = 'PageSection#'.$section->getKey()." [{$field}]: ".\Illuminate\Support\Str::limit($ar, 60);
