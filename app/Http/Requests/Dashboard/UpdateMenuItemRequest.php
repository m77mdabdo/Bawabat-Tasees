...
class UpdateMenuItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Also excludes the item itself: a row that is its own parent
            // would be an unreachable cycle.
            'parent_id' => [
                'nullable',
                Rule::notIn([$this->route('menu')?->getKey()]),
    ...
    public function messages(): array
    {
        return [
            ...
            'parent_id.not_in' => __('dashboard.menu.validation.parent_self'),
        ];
    }
}
